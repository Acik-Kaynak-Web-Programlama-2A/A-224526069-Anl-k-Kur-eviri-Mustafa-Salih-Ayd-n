...
def get_currency_list():
    try:
        ...
        data = response.json()
        # Sadece USD, EUR ve TRY kurlarını al
...
entry_miktar.bind("<FocusOut>", update_conversion)  # Giriş alanından odak çıkınca çevrimi güncelle
...
combo_giris_kuru.bind("<<ComboboxSelected>>", update_conversion)  # Para birimi seçildiğinde çevrimi güncelle
...
combo_hedef_kuru.bind("<<ComboboxSelected>>", update_conversion)  # Para birimi seçildiğinde çevrimi güncelle
